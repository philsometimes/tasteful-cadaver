...
def makeMeasureTool(x1,y1,z1,name1,x2,y2,z2,name2):
    ...
    #print newMeasure
    newLocators = [newMeasure[2],newMeasure[1]]    #grabs locators from list
    #print newLocators
    newLocators[0]=cmds.rename(newLocators[0],name1)
    newLocators[1]=cmds.rename(newLocators[1],name2)
    return newLocators
...
def perpendicularDistance(A,B,C):
...
#newLocators=makeMeasureTool(1,12,11,"B",13,15,20,"C")
#B_xyz,C_xyz=measureToolQuery()
#distanceResult=perpendicularDistance(A_xyz,B_xyz,C_xyz)
